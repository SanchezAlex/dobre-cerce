...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var langMenu = document.querySelector('.header__lang');

  langMenu.onclick = function (e) {
    if (e.target.tagName.toLowerCase() !== 'a') return;
    [].forEach.call(langMenu.querySelectorAll('a'), function (item) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var searchOpen = document.querySelector('#search__icon');
